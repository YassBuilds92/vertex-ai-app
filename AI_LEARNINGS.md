...
- [Auth Firebase / unauthorized-domain] -> Erreur survenant lors du déploiement ou du changement de domaine URL. Cause : Le nouveau domaine (ex: Vercel) n'est pas autorisé dans les paramètres Firebase. Solution : Console Firebase -> Authentification -> Paramètres -> Domaines Autorisés -> Ajouter le domaine.
